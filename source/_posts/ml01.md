...
{% img /uploads/images/ml01/gd.png 300 'gd' %}
...
4. Repeat 2), 3) ...
    - Compute $\dfrac{\partial L}{\partial w}|_{w=w^1,b=b^1}$, and $\dfrac{\partial L}{\partial b}|_{w=w^1,b=b^1}$
    - Update: $w^2$ and $b^2$
    - ...
...
{% img /uploads/images/ml01/100.png 400 'more data' %}
...
{% img /uploads/images/ml01/improv.png 400 'improvement' %}
...
{% img /uploads/images/ml01/bv.png 400 'bias and variance' %}
有四種情況：
- 左上：bias 小、vaiance 小。
    - 此為最理想的狀況。
...
若為一次方的 model：
{% img /uploads/images/ml01/mb1.png 400 'model and bias' %}
$\bar{f}$ 與 $\hat{f}$ 較遠。

若為五次方的 model：
{% img /uploads/images/ml01/mb2.png 400 'model and bias' %}
$\bar{f}$ 與 $\hat{f}$ 是接近的。
